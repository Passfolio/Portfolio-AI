...
# --- [메인 실행 및 전체 결과 출력] ---
# def main():
#     pdf_path = "/Users/sangbin/Downloads/test.pdf"
...
#     print(cleaned_md[:500] + "\n...") # 청소된 마크다운 일부 출력 (전체는 너무 길어서)

#     # 3. 분할 (LLM 없이 물리적 분할만 수행)
#     print("🔪 Step 2: 키워드 기반 섹션 분할 중...")
#     processed_chunks = split_by_entity_and_chunk(cleaned_md, max_chars=1500)

#     # 4. 전체 결과 출력
#     print("\n" + "="*60)
#     print(f"✅ 분석 완료: 총 {len(processed_chunks)}개의 데이터 덩어리가 생성되었습니다.")
#     print("="*60 + "\n")
    
#     for idx, item in enumerate(processed_chunks):
#         # 청크 정보 헤더
#         status = " [분할됨]" if item['is_chunked'] else ""
#         header = f"  CHUNK {idx+1} | 엔티티: {item['entity']}{status}  "
